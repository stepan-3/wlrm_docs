[img-collectd-nagios]:      ../../../images/en/monitoring/collectd-nagios.png
...
[link-metric]:              ../../admin-en/monitoring/available-metrics.md#number-of-attacks-reported
...
--8<-- "en/include-en/monitoring/metric-example.md"
<!-- -->
...
--8<-- "en/include-en/monitoring/nrpe-restart.md"
...
--8<-- "en//include-en/monitoring/nagios-restart.md"
