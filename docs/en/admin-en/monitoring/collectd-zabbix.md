[img-zabbix-scheme]:        ../../../images/en/monitoring/zabbix-scheme.png
...
[link-metric]:              available-metrics.md#number-of-attacks-reported
...
--8<-- "en/include-en/monitoring/install-zabbix-agent.md"
<!-- -->
...
--8<-- "en/include-en/monitoring/zabbix-agent-restart.md"
